document.addEventListener('DOMContentLoaded', () => {
    ...
    const containerOhneSlider = document.getElementById('jung-wien-container-ohne-slider');
              ...
              Papa.parse(csvText, {
                  ...
                  complete: (results) => {
                      ...
                      if (chartData) {
                          ...
                          chartOhneSlider = Highcharts.chart('jung-wien-container-ohne-slider', buildChartConfig(chartData, 300));
                      }
                      ...
                      const containerMitSlider = document.getElementById('jung-wien-container-mit-slider');
    ...
    function createChartForYear(year) {
        ...
        if (chartData) {
            chartMitSlider = Highcharts.chart('jung-wien-container-mit-slider', buildChartConfig(chartData, 100));
        }
    }
