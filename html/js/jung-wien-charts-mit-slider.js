document.addEventListener('DOMContentLoaded', () => {
    ...
    const forceRedraw = () => {
        if (window.chartMitSlider) {
            window.chartMitSlider.reflow(); // Forces the chart to redraw and fit within its container
        }
    };
    ...
    loadCSV('https://raw.githubusercontent.com/arthur-schnitzler/schnitzler-briefe-charts/main/netzwerke/jung-wien/jung-wien-ist-alle-per-year.csv');
});
