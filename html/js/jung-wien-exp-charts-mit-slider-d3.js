document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialisiere Chart-Container basierend auf verfügbaren Elementen
    if (document.getElementById('jung-wien-container-nebeneinander-mit-slider')) {
        initChartWithSlider('jung-wien-container-nebeneinander-mit-slider', 'csvDropdown-nebeneinander-mit-slider');
    }
