...
for (let i in data) {
// If the current object's filename property does match the filuname parameter, continue to the next object
if (data[i].type === 'schnitzler-xx' && filuname === data[i].filename) {
} else {
