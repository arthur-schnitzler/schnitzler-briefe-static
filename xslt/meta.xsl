...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
                ...
                <div class="hfeed site" id="page">
                    ...
                    <div class="container-fluid">
                        ...
                        <nav class="crumbs mt-1" aria-label="Brotkrumennavigation" style="--project-color: {$current-colour};">
                            <span class="type-pill">Seite</span>
                        </nav>
                        <div class="card">
    ...
    <!-- Template für jung-wien-container-ohne-slider: volle Breite -->
    <xsl:template match="tei:div[@xml:id = 'jung-wien-container-ohne-slider']">
