    ...
    <xsl:template match="/">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="corr-name"
                select="mam:vorname-vor-nachname(tei:persName[@role = 'main'][1]/text())"/>
            <xsl:if test="
                    unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv')) or
                    unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv')) or
                    unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv')) or
                    unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv')) or
                    unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                <xsl:result-document href="{$filename}">
                    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
                    <html xmlns="http://www.w3.org/1999/xhtml" style="hyphens: auto;" lang="de" xml:lang="de">
                        <xsl:call-template name="html_head">
                            ...
                            <div class="hfeed site" id="page">
                                ...
                                <div class="container">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <xsl:if
                                                test="unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                                                ...
                                                <div id="chart-buttons" class="text-center mt-3"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv'))">
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv')) or unparsed-text-available(concat('../network-data/person_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                            ...
                                            <xsl:if
                                                test="unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                                                ...
                                                <div id="chart-buttons" class="text-center mt-3"
                                                  style="margin: auto; padding-bottom: 40px">
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv')) or unparsed-text-available(concat('../network-data/place_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                            ...
                                            <xsl:if
                                                test="unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                                                <h3 style="text-align: center;">Erwähnte
                                                  Institutionen</h3>
                                                ...
                                                <div id="chart-buttons" class="text-center mt-3"
                                                  style="margin: auto; padding-bottom: 40px">
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv')) or unparsed-text-available(concat('../network-data/institution_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                            ...
                                            <xsl:if
                                                test="unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                                                ...
                                                <div id="chart-buttons" class="text-center mt-3"
                                                  style="margin: auto; padding-bottom: 40px">
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv')) or unparsed-text-available(concat('../network-data/work_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                            ...
                                            <xsl:if
                                                test="unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_alle.csv'))">
                                                ...
                                                <div id="chart-buttons" class="text-center mt-3"
                                                  style="margin: auto; padding-bottom: 40px">
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
                                                  ...
                                                  <xsl:if
                                                  test="unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top30.csv')) or unparsed-text-available(concat('../network-data/event_freq_corr_weights_directed_correspondence_', substring-after($corr-id, 'pmb'), '_top100.csv'))">
                                                  <button class="btn mx-1 chart-btn"
                                                  style="background-color: #A63437; color: white; border: none; padding: 2px 10px; font-size: 0.875rem;"
