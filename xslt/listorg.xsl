                ...
                <div class="hfeed site" id="page">
                    ...
                    <div class="container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mb-3">
                                    <a href="netzwerke.html" class="btn btn-sm" style="background-color: #A63437; color: white; border: none;">Zu den häufigsten Institutionen (Netzwerk)</a>
                                </p>
                                    ...
                                    <table class="table table-sm display" id="tabulator-table-org">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" tabulator-headerFilter="input"
                                                  tabulator-formatter="html">Orte</th>
                                                <th scope="col" tabulator-headerFilter="input"
